...
class Movie(models.Model):
    ...
    year = models.PositiveIntegerField('Год', default=2019)
...
class Rating(models.Model):
    '''Рейтинг'''
    ip = models.CharField('Ип адресс', max_length=15)
    stars = models.ForeignKey(RatingStars, on_delete=models.CASCADE, verbose_name='звезда')
